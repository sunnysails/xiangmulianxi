            ...
            <div class="box box-solid box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <div class="box-tools pull-right">
                            <a href="/business/lease/new" class="btn"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="box-body">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered table-hover table-expandable">
                                ...
                                <tbody>
                                <c:forEach items="${leaseList}" var="lease">
                                    <tr align="center">
                                        <td>${lease.leaseAccount}</td>
                                        <td>${lease.leaseCompany}</td>
                                        <td>${lease.leaseCompanyPhone}</td>
                                        <td>${lease.leaseLegal}</td>
                                        <td>${lease.leaseLegalPhone}</td>
                                        <td>${lease.leaseLegalIdCard}</td>
                                            ...
                                            <c:forEach items="${lease.leaseDeviceList}" var="leaseDevice">
                                                <div class="col-md-6">
                                                    <div class="box box-primary">
                                                        <div class="box-header with-border">
                                                            <h3 class="box-title">
                                                                租赁“${leaseDevice.device.deviceName}”${leaseDevice.leaseNum}${leaseDevice.device.deviceUnit}
                                                            </h3>
                                                        </div>
                                                        <!-- /.box-header -->
